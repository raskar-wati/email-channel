import svgPaths from "./svg-7plyvdcdt7";
...
export default function Container() {
  return (
    <div className="relative size-full" data-name="Container">
      ...
      />
      <div
        className="absolute bottom-[3.571%] left-[60.714%] right-[3.571%] top-[64.286%]"
        data-name="Vector"
      >
        <div className="absolute bottom-[-11.105%] left-[-10%] right-[-10%] top-[-11.111%]">
          <svg
